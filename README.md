...
# Statistics
Update of the following table: 2025-12-26 14:37 CEST

| Malicious IP addresses in full-\*                          | %       | Number of IPs |
| ---------------------------------------------------------- | ------- | ------------- |
| Present in 6 sources and more | 5.47 % | 27 025 |
| Present in 5 sources | 6.17 % | 30 484 |
| Present in 4 sources | 7.34 % | 36 293 |
| Present in 3 sources | 7.43 % | 36 707 |
| Present in 2 sources | 19.60 % | 96 829 |
| Present in 1 source | 53.97 % | 266 571 |
| Total | 100 % | 493 909 |

Update of the common IP table with the FortiGate ISDB Malicious-Malicious.Server: 2025-12-26 01:50 CEST
